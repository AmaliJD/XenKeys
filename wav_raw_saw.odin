...
// ----------------------------------------------------------------------------------- morph to pulse
saw_to_pulse :: saw_to_pulse_flat

@private
saw_to_pulse_flat :: proc(phase, warp: f32) -> f32
{
...
@private
saw_to_pulse_floor :: proc(phase, warp: f32) -> f32
{
...
@private
saw_to_pulse_squish :: proc(phase, warp: f32) -> f32
{
...
// ----------------------------------------------------------------------------------- morph to square
saw_to_square :: saw_to_square_lerp

@private
saw_to_square_lerp :: proc(phase, warp: f32) -> f32
{
    return math.lerp(saw(phase), square(phase), warp)
}

@private
saw_to_square_curved :: proc(phase, warp: f32) -> f32
{
